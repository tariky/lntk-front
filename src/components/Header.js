...
import BigItem from "./Header_Small_Comp/BigItem";
      ...
      <div className="p-2">
        <div className="d-flex justify-content-between align-items-center">
          <button className="btn btn-default">
            <Justify style={{ fontSize: "26px" }} />
          </button>
          <span style={{ fontSize: "25px", fontWeight: "bold" }}>Lunatik</span>
          <button className="btn btn-default">
            <Bag style={{ fontSize: "26px" }} />
          </button>
        </div>
      </div>
      <div className="fixed-top overflow-auto bg-white p-3" style={{ height: "100vh" }}>
        <div className="d-flex flex-column">
          ...
          <div className="d-flex flex-column pt-3 mt-5">
            <BigItem title={"Pocetna"} />
            <BigItem title={"Snizeno"} />
            <BigItem title={"Odjeca"} />
            <BigItem title={"Dodaci"} />
          </div>
